% Cross Validation CPSVM_1 (gaussian kernel)

clc
clear all

% Definición de los rangos de exploración para los parámetros C,
% epsilon y sigma
...
filename_xlsx = 'CV_CPSVM_V1_nolineal.xlsx';

% Nombres de los valores posibles de los parámetros C1=C2, epsilon y sigma
...
filename_mat = "CV_CPSVM_V1_nolineal.mat";
...
for dataset = datasets
        ...
        for i=C_l:C_h
            ...
            for j=eps_l:eps_h                
                ...
                for k=1:folds
                    ...
                    Y_predic = cpsvm_dual_qpV1(X_train,Y_train,X_test,FunPara); % Predicciones via quadprog
                ...
                BACMATRIX(t-sigma_l+1,i-C_l+1,j-eps_l+1)=i+j+t;
                ACCUMATRIX(t-sigma_l+1, i-C_l+1,j-eps_l+1)=-i-j-t; 
    ...
    param = ["sigma", "C1=C2", "eps"]; % Nombre de los parámetros
